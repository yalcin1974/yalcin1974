...
### 👨‍💻 Hakkımda
Ben yazılım geliştirme süreçlerine odaklanmış bir teknik eğitim öğrencisiyim. Özellikle kurumsal otomasyonlar, web tabanlı katalog sistemleri ve lojistik çözümleri üzerine projeler geliştiriyorum.

---

### 🎓 Akademik Durum ve Hedef
* **Mevcut Durum:** Teknik eğitim öğrencisi.
* **Akademik Hedef:** Temmuz 2026 DGS (Dikey Geçiş Sınavı) ile Bilgisayar Mühendisliği veya Yönetim Bilişim Sistemleri (YBS) lisans programına geçiş yapmak.
* **Sınav Odağı:** Matematik netlerini 10'dan 40'a çıkarmayı hedefleyen disiplinli bir çalışma süreci.
...
### 🚀 Başlıca Projelerim
* **[YalcinLojistik](https://github.com/yalcin1974/YalcinLojistik):** Kurumsal lojistik ve araç filosu tanıtım web sitesi.
* **[TeknikServisOtomasyonu](https://github.com/yalcin1974/TeknikServisOtomasyonu):** Servis kayıt ve müşteri yönetim odaklı C# WinForms uygulaması.
* **[UrunKatalogu](https://github.com/yalcin1974/UrunKatalogu):** ASP.NET Core MVC ile geliştirilmiş dinamik ürün listeleme projesi.
